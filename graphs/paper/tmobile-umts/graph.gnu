...
set xrange [ 20490 : 3500 ] noreverse nowriteback
set yrange [ 9 : 14 ] noreverse nowriteback
set xtics (100, 200, 300, 500, 700, 1000, 2000, 3500, 5000, 7000, 10000, 14000, 18000)
...
"Salsify-1.dat" using 3:4:("Salsify-1c") with labels center offset 0, char 2.5 font "Arial:Bold, 28" tc rgb "#333333" notitle,\
"Salsify-2.dat" using 3:4 with linespoints ls 7 ps 3 lt rgb "#DF006F", \
"Salsify-2.dat" using 3:4:("Salsify-2c") with labels right offset -2.5, char 0 font "Arial:Bold, 28" tc rgb "#DF006F" notitle,\
