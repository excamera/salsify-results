...
"WebRTC-SVC.dat" using 3:4:("WebRTC (VP9-SVC)") with labels center offset 1, char 2 font "Arial:Bold, 28" tc rgb "#AC4F1F" notitle,\
"Salsify-2.dat" using 3:4 with linespoints ls 2 ps 3 lt rgb "#DF006F", \
"Salsify-2.dat" using 3:4:("Salsify-2c") with labels left offset -18.5, char 0.25 font "Arial:Bold, 28" tc rgb "#DF006F" notitle,\
"Salsify-1.dat" using 3:4 with linespoints ls 3 ps 3 lt rgb "#333333", \
"Salsify-1.dat" using 3:4:("Salsify-1c") with labels center offset 10, char 0.25 font "Arial:Bold, 28" tc rgb "#333333" notitle,\
