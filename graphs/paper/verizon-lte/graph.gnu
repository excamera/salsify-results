...
"Salsify-1.dat" using 3:4 with linespoints ls 7 ps 3 lt rgb "#333333", \
...
"WebRTC.dat" using 3:4:("WebRTC") with labels left offset 3, char 0 font "Arial:Bold, 28" tc rgb "#0000a0" notitle, \
